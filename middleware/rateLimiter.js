...
exports.otpLimiter = limiter(1, 20, 'Too many OTP requests. Please wait 15 minutes and try again.');

// ─── Auth routes (login / register) ──────────────────────────────────────────
// Max 10 attempts per 15 min per IP.
// Slows down credential stuffing without blocking legit users.
exports.authLimiter = limiter(1, 20, 'Too many login attempts. Please wait 15 minutes and try again.');
